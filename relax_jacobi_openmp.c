...
struct relaxation_jacobi_openmp_hidden_params_s {
    struct relaxation_params_s super;
    double* data[2];
    uint32_t idx;
};
const struct relaxation_function_class_s _relaxation_jacobi_openmp;

static struct relaxation_params_s*
jacobi_openmp_relaxation_init(struct hw_params_s* hw_params)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp;
    uint32_t np = hw_params->resolution + 2;

    rp = (struct relaxation_jacobi_openmp_hidden_params_s*)malloc(sizeof(struct relaxation_jacobi_openmp_hidden_params_s));
    if( NULL == rp ) {
    ...
    rp->super.sizex = np;
    rp->super.sizey = np;
    rp->super.rel_class = &_relaxation_jacobi_openmp;
...
static int jacobi_openmp_relaxation_fini(relaxation_params_t** prp)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp = (struct relaxation_jacobi_openmp_hidden_params_s*)*prp;
    if( NULL != rp->data[0] ) free(rp->data[0]);
    if( NULL != rp->data[1] ) free(rp->data[1]);
    free(rp);
    *prp = NULL;
...
static int jacobi_openmp_relaxation_coarsen(relaxation_params_t* grp, double* dst, uint32_t dstx, uint32_t dsty)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp = (struct relaxation_jacobi_openmp_hidden_params_s*)grp;

    return coarsen(rp->data[(rp->idx + 1) % 2], rp->super.sizex, rp->super.sizey,
                   dst, dstx, dsty);
}

static int jacobi_openmp_relaxation_print(relaxation_params_t* grp, FILE* fp)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp = (struct relaxation_jacobi_openmp_hidden_params_s*)grp;
    fprintf( fp, "\n# Iteration %d\n", rp->idx);
...
/**
 * One step of a simple jacobi_openmp relaxation.
 */
static double jacobi_openmp_relaxation_apply(relaxation_params_t* grp)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp = (struct relaxation_jacobi_openmp_hidden_params_s*)grp;
...
static double* jacobi_openmp_relaxation_get_data(relaxation_params_t* grp)
{
    struct relaxation_jacobi_openmp_hidden_params_s* rp = (struct relaxation_jacobi_openmp_hidden_params_s*)grp;
...
const struct relaxation_function_class_s _relaxation_jacobi_openmp =
    {
		...
		.method_name = "OpenMP for Jacobi relaxation",
		._init = jacobi_openmp_relaxation_init,
        ._fini = jacobi_openmp_relaxation_fini,
        ._coarsen = jacobi_openmp_relaxation_coarsen,
        ._print = jacobi_openmp_relaxation_print,
        ._relaxation = jacobi_openmp_relaxation_apply,
        ._get_data = jacobi_openmp_relaxation_get_data,
    };
